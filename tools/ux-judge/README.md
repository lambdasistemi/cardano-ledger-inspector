...
## Run
```sh
nix develop -c bash tools/ux-judge/run.sh                 # judge live prod
UX_BASE_URL=https://preview.dev.plutimus.com/.../pr-NN/inspector/ \
  nix develop -c bash tools/ux-judge/run.sh               # judge a preview
```
